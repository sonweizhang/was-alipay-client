...
<% 
	String staticWebPath="http://static.99114.cn"; //静态工程地址
	String menuWebPath="http://menu.99114.cn"; //菜单工程地址
	String businessWebPath="http://oppor.99114.cn";  //发布商机地址
	String dealBusinessWebPath="http://deal-business.99114.cn";  //发布商机地址
	String quoteWebPath="http://quote.99114.cn";  //发布商机地址2
	...
	String infoPath ="http://zixun.99114.cn/";//资讯
	String zhuantiPath ="http://zhuanti.99114.cn/";//专题
	String loginPath="http://checkin.99114.cn/";// 登录
	String helpPath = "http://help.99114.cn";//帮助
	String appPath = "http://app.99114.cn";//应用中心
	String qutoePath = "http://quote.99114.cn";
%>
<%
	...
	String memberPath= menuWebPath+"?mType=6&fromUrl=";//会员中心
	String memberApplication= menuWebPath+"?mType=7&fromUrl=";//应用中心
...
买卖家 首页 	URL	 */
    ...
    */
	...
	// 买家中心  采购新
	String buyPurchaseNew=quoteWebPath+"/purchase/getPager?currentPage=1&pageSize=10&status=2";
	
	// 买家中心  交易  等待付款
	String buyTradePay=dealBusinessWebPath+"/buyerOrders/toBuyerOrdersList?status=0&currentPage=1&pageSize=10&orderStatus=1";
	// 买家中心  交易  确认收货
	String buyTradeReceipt=dealBusinessWebPath+"/buyerOrders/toBuyerOrdersList?status=2&currentPage=1&pageSize=10&orderStatus=6";
	// 买家中心  交易  等待卖家发货
	String buyTradeConfirmOrder=dealBusinessWebPath+"/buyerOrders/toBuyerOrdersList?status=1&currentPage=1&pageSize=10&orderStatus=3";
	// 买家中心  交易   等待评价
	...
	// 买家中心  潜在生意  已发出寻盘
	String buyFromQuotedPrice=qutoePath+"/quote/searchList?currentPage=1&pageSize=5";
		
	// 买家中心 　为您推荐  补充采购信息
	String buyAddPurchase=memberWebPath+"/memberDetail/getCompanyDetial";	
	
	String businessLibrary=qutoePath+"/purchase/searchSupplierPager";
%>	
<%  
